...
<div class="container">
    ...
    <div class=" bg-dark text-light text-center">
        <h1 class="display-5">Customer Registration Form</h1>
    ...
    <form class="shadow p-3 mb-3 bg-white rounded" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="preference" id="preference" value="Customer" disabled>
        </div>
        <div class="form-group">
            <label for="phone">phone<sup class="text-danger">*</label>
            <input type="text" class="form-control" name="phone" id="phone" placeholder="98-180-92061" required>
